        ...
        <div className="mb-20 lg:mb-24">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16 lg:mb-20">
            ...
            <div className="relative order-1 lg:order-1">
              <div className="relative bg-gradient-to-br from-gray-900/80 to-charcoal/90 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
                <div className="w-80 h-80 mx-auto rounded-2xl overflow-hidden bg-gray-800 border border-gray-600">
            ...
            <div className="space-y-6 order-2 lg:order-2">
              <div>
                <h3 className="text-3xl sm:text-4xl font-montserrat font-bold text-white mb-2">
                  Tommy
                </h3>
                <p className="text-xl text-neon-green font-montserrat font-semibold mb-4">
                  Co-owner
                </p>
              ...
              <div className="space-y-4 text-gray-300 font-open-sans leading-relaxed">
                <p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 order-2 lg:order-1">
              <div>
                ...
                <p className="text-xl text-gold font-montserrat font-semibold mb-4">
                  Founder
                </p>
                <div className="flex gap-4 mb-6">
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative bg-gradient-to-br from-gray-900/80 to-charcoal/90 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
                ...
                <div className="absolute -top-4 -left-4 w-32 h-32 bg-gold/20 rounded-full blur-xl animate-pulse"></div>
              </div>
            </div>
          </div>
        </div>
