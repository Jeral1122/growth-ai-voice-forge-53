...
import { OutboundHeroSection } from '../components/sections/outbound/HeroSection';
import { ProactiveEngagementSection } from '../components/sections/outbound/ProactiveEngagementSection';
import { OutboundFeaturesGrid } from '../components/sections/outbound/FeaturesGrid';
import { CampaignTypesSection } from '../components/sections/outbound/CampaignTypesSection';
import { HowOutboundWorksSection } from '../components/sections/outbound/HowOutboundWorksSection';
...
const OutboundCalls = () => {
  ...
  return (
    <BackgroundLayout>
      <NavBarDemo />
      <OutboundHeroSection />
      <ProactiveEngagementSection />
      <OutboundFeaturesGrid />
      <CampaignTypesSection />
      <HowOutboundWorksSection />
      <ConnectSection />
      <TestimonialsSection />
      <FAQSection
